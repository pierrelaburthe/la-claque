...
export const PIECES: Piece[] = [
  ...
  },
  {
    ...
    signataire: 'pierre',
    chapo: "Sarkozy en stand-up, Hollande en clown, et la France de 2007 à 2017 passée à la moulinette. Une traversée de l'époque menée à vive allure.",
    corps: [
      "Sur le plateau, deux présidents de la Ve République rejouent dix ans de vie politique française, de la crise économique au mariage pour tous, de Carla Bruni aux attentats. Nicolas Sarkozy y est incarné en comique de stand-up, François Hollande en clown voué à l'échec, avant qu'une troisième voix ne s'empare de la scène. Le texte est cosigné par l'équipe du cycle « Huit Rois », déjà à l'origine de notre Chirac adoré.",
      "La pièce n'est pas un seul-en-scène mais un trio, et sa dernière partie bascule dans un tout autre registre : Léïla Merabet, jeune femme née à Livry-Gargan et devenue figure de Marianne, déroule un monologue-fleuve hypnotique d'un quart d'heure. C'est la grande prouesse de la soirée, quinze minutes d'affilée sans le moindre accroc et avec du fond.",
      "Sarkozy fait rire, Hollande émeut par sa maladresse, et ce final vient cueillir la salle là où elle ne l'attendait pas. Une comédie identitaire brillante, formidablement interprétée, qui montre nos présidents impuissants sans jamais tomber dans le tract. La cerise sur le gâteau.",
    ],
    momentGarde: "Le monologue-fleuve de la fin, quinze minutes portées d'un seul souffle, qui font basculer la comédie dans l'émotion pure.",
    sources: [
  ...
  },
  {
    ...
    signataire: 'pierre',
    chapo: "Une usine qu'on délocalise, un détenu qui se fait délégué syndical, et une batterie qui bat le rythme de la colère. Une comédie engagée qui frappe fort.",
    corps: [
      "Émile obtient un aménagement de peine : l'usine le jour, la cellule la nuit. Sauf que l'usine qui l'embauche est sur le point d'être délocalisée. Pour se sauver, Émile n'a plus qu'une option, devenir le meilleur des syndicalistes et se présenter comme délégué pour défendre la boîte, ses collègues, et peut-être le pays. Le texte de Samuel Valensi tient de la comédie engagée sur la désindustrialisation.",
      "Cinq comédiens font surgir une vingtaine de personnages dans une mise en scène dynamique et enlevée, mais la vraie trouvaille est au centre du plateau : une batterie, jouée en direct, qui épouse le rythme du travail et la colère qui monte dans l'atelier. Le procédé électrise le récit et nous embarque dans une histoire qui paraît, comme on l'a noté à la sortie, plus vraie que vraie.",
      "Sous le rire et les quiproquos, souvent irrésistibles, affleure une réalité tragique, et c'est tout l'art de la pièce que de les faire cohabiter. Sincère, généreuse, portée par des interprètes formidables et un rythme qui ne retombe jamais, elle a mis tout le monde d'accord chez nous.",
    ],
    momentGarde: "La batterie au centre du plateau, qui bat d'abord le tempo du travail à la chaîne puis celui de la révolte, et fait monter la tension d'un cran à chaque roulement.",
    sources: [
  ...
  },
  {
    ...
    signataire: 'julie',
    chapo: "Une mère choisit de partir, et demande à son fils de l'accompagner. Une pièce sur la fin de vie, juste et tonique, qui nous a fait pleurer.",
    corps: [
      "Annie a décidé d'abréger sa vie par un suicide assisté, et demande à son fils cadet, Étienne, de l'accompagner jusqu'au bout, en Suisse. La pièce ne regarde pas tant celle qui s'en va que « ceux qui restent » : ceux qui doivent accepter, soutenir, puis continuer. En marge se noue une histoire d'amour naissante entre Étienne et Juliette.",
      "Anne de Peufeilhoux porte le rôle de la mère avec une justesse rare, et ce sont ses scènes, celles où elle choisit sereinement de mourir, qui bouleversent le plus. La pièce a d'ailleurs été retenue par l'Association pour le droit de mourir dans la dignité dans sa sélection sur la fin de vie, preuve du sérieux avec lequel elle empoigne le sujet, sans jamais tomber dans le pathos.",
      "L'intrigue amoureuse prend peut-être un peu trop de place, et le rythme flanche par moments, mais l'essentiel est ailleurs : c'est l'une des rares pièces qui nous a arraché des larmes. Vivante et tonique là où on la craignait plombante, elle regarde la mort en face avec une tendresse désarmante.",
    ],
    momentGarde: "Les scènes de la comédienne qui choisit de partir : sa sérénité et sa justesse rendent l'adieu insoutenable de vérité.",
    sources: [
